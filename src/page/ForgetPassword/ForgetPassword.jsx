...
import PhoneInputMask from "../../components/InputMask/PhoneInputMask";
...
const ForgetPassword = () => {
  ...
  const [resendSuccessMessage, setResendSuccessMessage] = React.useState("");
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
      ...
      setSuccessMessage(
        response.data.message || "Otp Message sent successfully."
      );
      setIsOtpSend(true);
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
      {successMessage ? (
        ...
        <CustomAlert
          message="Success"
          type="success"
          description={resendSuccessMessage}
          onClose={() => setResendSuccessMessage("")}
          showIcon
          className="w-[25%]"
        />
      ) : errorMessage ? (
